SELECT DISTINCT
	...
	E085CLI.CGCCPF AS CNPJ
	,E301MCR.DATGER AS DATA_GERACAO
...
WHERE
	E301MCR.CODEMP = E301TCR.CODEMP
  	...
  	AND E301TCR.CODEMP IN (2, 5)
  	AND E001TNS.LISMOD <> 'CRP'
  	AND E301TCR.SITTIT <> 'CA'
	AND E301TCR.DATENT >= TO_DATE('REPLACE_START_DATE', 'yyyy-mm-dd')
	AND E301TCR.DATENT < TO_DATE('REPLACE_END_DATE', 'yyyy-mm-dd')
-- OBS: Qualquer alteração nesta consulta, replique na consulta de titulos_contas_receber_por_geracao
