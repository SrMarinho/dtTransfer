...
class AcompanhamentoSolicitacoesCompras(Queryable):
    def __init__(self, params):
        ...
        self.tableName = 'acopanhamento_solicitacoes_compras'
    
    def getQuery(self) -> str:
        with open('sqls/consulta_acopanhamento_solicitacoes_compras.sql', 'r') as file:
            return file.read()
    ...
    def createTable(self):
        creationQuery = """
            CREATE TABLE acopanhamento_solicitacoes_compras (
