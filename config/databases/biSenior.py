...
class BiSenior():
    def __init__(self):
        self.driver = 'pgsql'
        self.host = os.getenv("DB_BISENIOR_POSTGRES_HOST")
        self.port = os.getenv("DB_BISENIOR_POSTGRES_PORT")
        self.database = os.getenv("DB_BISENIOR_POSTGRES_DATABASE")
        self.username = os.getenv("DB_BISENIOR_POSTGRES_USERNAME")
        self.password = os.getenv("DB_BISENIOR_POSTGRES_PASSWORD")
