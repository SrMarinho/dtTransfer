SELECT 
	...
	FROM E405SOL S
		...
		INNER JOIN R999USU ru 
				ON ru.CODUSU = c.USUCOT
	WHERE 
		S.codemp=2 
	  	AND S.DATSOL >='01/01/2024'
	  	--AND c.SITAPR = 	'APR'
UNION ALL
	SELECT 
		S.PROSER AS PRODUTO_OU_SERVICO,
